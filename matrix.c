...
struct matrix * make_rotX(double theta) {
   struct matrix *m;
	...
	m->m[1][1]=cos(0.0174532925*theta);
	m->m[1][2]=-1*sin(0.0174532925*theta);
	m->m[2][1]=sin(0.0174532925*theta);
...
struct matrix * make_rotZ(double theta) {
	...
	m->m[0][0]=cos(0.0174532925*theta);
	m->m[0][1]=-1*sin(0.0174532925*theta);
	m->m[1][0]=sin(0.0174532925*theta);
	m->m[1][1]=cos(0.0174532925*theta);
  return m;
}
